...
export default function Navbar({ contact }: Props) {
  return (
    <nav className="fixed z-20 bg-[#111] w-full h-auto md:px-12 p-4 py-6 items-center justify-between flex">
        <Link href="/" className="font-mango text-xl flex gap-2 items-center hover:translate-x-1 transition ease-in-out"><img src="./logo.png" className="h-10" alt='soluvaa' />SOLUVAA</Link>
